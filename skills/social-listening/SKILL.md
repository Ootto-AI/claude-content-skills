...
description: >
  Social Listening for evidence-led social marketing. Use when the user says "what are people asking, what language do customers use, or what demand is here" and supplies relevant material. NOT for scraping platforms or claiming market demand without supplied evidence; use agent-reach to collect material first.
user-invokable: true
...
agent-reach → social-listening → audience-personas → campaign-brief.
