...
description: >
  Cross-platform Distribution for evidence-led social marketing. Use when the user says "adapt this for LinkedIn and X, distribute this campaign, or how should this travel across platforms" and supplies relevant material. NOT for changing approved claims or creating a new strategy; use campaign-brief first.
user-invokable: true
...
campaign-brief → cross-platform-distribution → social-analytics-report.
